...
select * from Book;
select Exists(select isbn from book where isbn = '0806666613');
select exists(select isbn from book where isbn = '0806666613');
insert  into book VALUES('5246000000', 'Python Programming', 2018, 'ABC', null, 18.3);
select isbn, title from book where published_by like '%Wesley%';
select isbn, title,price from book where year = '2008';
CREATE TABLE Book(
...
delete from Publisher where name = 'mypublihser'
